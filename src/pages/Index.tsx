      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-prose relative pt-20 pb-24 md:pt-28 md:pb-32">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-semibold tracking-tighter leading-[1.02] animate-float-up">
              Observability,
              <br />
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 animate-float-up">
              <StatusPill
                label="all systems · ingest 4.2M spans/min"
                status="ok"
              />
              <StatusPill
                label="cardinality budget · 78% utilized"
                status="warn"
              />
              <StatusPill
                label="SLO burn · within budget"
                status="ok"
              />
            </div>
          </div>
        ...
        <div className="relative overflow-hidden border-t border-border">
          <div className="flex gap-12 py-5 animate-ticker whitespace-nowrap">
            {[...LOGOS, ...LOGOS, ...LOGOS].map((l, i) => (
              <span
                key={i}
                className="mono text-sm tracking-[0.2em] text-muted-foreground/70 hover:text-foreground transition-colors"
              >
                {l}
              </span>
            ))}
      ...
      <section className="container-prose py-20 md:py-24">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-4">
            ...
            <h2 className="mt-2 text-3xl md:text-4xl font-semibold tracking-tight">
              Twelve domains. One discipline.
            </h2>

            <p className="mt-4 text-muted-foreground leading-relaxed">
              We write across the entire observability and reliability stack —
              from collector internals to org-wide SLO programs.
            </p>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-3">
            {CATEGORIES.map((c) => (
              ...
              >
                ...
                <div className="mt-1 text-sm font-medium group-hover:text-primary transition-colors">
                  {c}
                </div>
              </Link>
            ))}
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 text-muted-foreground">
                We run focused engagements with platform and SRE teams:
                architectural reviews, monitoring assessments, and reliability
                deep-dives. Typically 2–6 weeks. Outcomes, not slideware.
              </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="surface-card p-8">
            ...
            <h3 className="mt-4 text-xl font-semibold">
              A community is being assembled.
            </h3>

            <p className="mt-2 text-sm text-muted-foreground">
              A practitioner forum for SREs, platform engineers and
          ...
          <div className="surface-card p-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Battle-tested runbooks, dashboards and SLO templates — packaged
              and ready to deploy.
            </p>
