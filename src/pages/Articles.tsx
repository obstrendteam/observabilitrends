...
export default function Articles() {
  ...
  return (
    <PageLayout title="Articles - ObservabiliTrends" description="Field reports, playbooks and deep dives on observability, SRE and platform engineering." canonical="/articles">
